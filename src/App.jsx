...
import AssignTasks from "@/pages/authority/AssignTasks";
...
function ProtectedRoute({ children, allowedRoles }) {
  ...
  if (allowedRoles && !allowedRoles.includes(user?.role)) {
    return (
      <Navigate
        to={ROLE_HOME_PATHS[user?.role] || ROUTES.citizen.home}
        replace
      />
    );
  }
  ...
  return (
    <Routes>
      ...
      <Route path={ROUTES.home} element={<PublicLayout />}>
        ...
        <Route
          path={toRelativePath(ROUTES.howItWorks)}
          element={<HowItWorks />}
        />
      ...
      >
        <Route
          path={ROUTES.citizen.reportDetails()}
      ...
      >
        ...
        <Route path={ROUTES.authority.assign} element={<AssignTasks />} />
        <Route
          path={ROUTES.authority.resolution}
          element={
            <PlaceholderPage
              title="Resolution Tracking"
              description="Before/after photo verification and resolution management."
            />
          }
        />
        <Route
          path={ROUTES.authority.analytics}
          element={
            <PlaceholderPage
              title="Ward Analytics"
              description="Detailed ward-level analytics and performance metrics."
            />
          }
        />
        <Route
          path={ROUTES.authority.escalation}
          element={
            <PlaceholderPage
              title="Escalations"
              description="Manage escalated reports and override timers."
            />
          }
        />
        <Route
          path={ROUTES.authority.workers}
          element={
            <PlaceholderPage
              title="Worker Management"
              description="Manage cleanup workers, assignments, and performance."
            />
          }
        />
      </Route>
        ...
        <Route
          ...
          element={
            <PlaceholderPage
              ...
              description="City-wide analytics and downloadable reports."
            />
          }
        />
        <Route
          ...
          element={
            <PlaceholderPage
              ...
              description="Real-time API health, database status, and queue metrics."
            />
          }
        />
        <Route
        ...
        <Route
          ...
          element={
            <PlaceholderPage
              ...
              description="AI validation thresholds and content moderation rules."
            />
          }
        />
        <Route
          ...
          element={
            <PlaceholderPage
              ...
              description="Review and approve/reject community campaigns."
            />
          }
        />
      </Route>
        ...
        <Route
          ...
          element={
            <PlaceholderPage
              ...
              description="Overview of your organization's waste compliance and metrics."
            />
          }
        />
        <Route
          ...
          element={
            <PlaceholderPage
              title="Bulk Compliance"
              description="Segregation compliance tracking and audit trail."
            />
          }
        />
        <Route
          path={ROUTES.organization.tracking}
          element={
            <PlaceholderPage
              title="Waste Tracking"
              description="Category-wise waste generation tracking and trends."
            />
          }
        />
        <Route
          path={ROUTES.organization.participation}
          element={
            <PlaceholderPage
              title="Campaign Participation"
              description="Team participation history and leaderboard."
            />
          }
        />
      </Route>
          ...
          <PublicLayout>
            <div className="min-h-[60vh] flex items-center justify-center">
              <div className="text-center">
                <h1 className="text-6xl font-extrabold text-[var(--text-tertiary)] mb-4">
                  404
                </h1>
                ...
                <Link
                  to={ROUTES.home}
                  className="text-civic-500 hover:text-civic-600 font-medium"
                >
                  ← Back to Home
                </Link>
              </div>
