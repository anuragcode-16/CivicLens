...
=======
  {
    ...
    severity: "MEDIUM",
    status: "pending",
    description: "Pile of plastic bags and bottles dumped near park entrance",
    gps_lat: 12.9716,
    gps_lng: 77.5946,
  ...
  },
  {
    ...
    severity: "HIGH",
    status: "in-progress",
    description: "Rotting food waste dumped along the drainage canal",
    gps_lat: 12.9756,
    gps_lng: 77.5906,
  ...
  },
  {
    ...
    severity: "HIGH",
    status: "overdue",
    description: "Construction rubble blocking the footpath",
    gps_lat: 12.9686,
    gps_lng: 77.5976,
  ...
  },
  {
    ...
    severity: "MEDIUM",
    status: "resolved",
    description: "Old monitors and circuit boards abandoned near bin",
    gps_lat: 12.9616,
    gps_lng: 77.6046,
    created_at: "2024-03-12T11:45:00Z",
    resolved_at: "2024-03-13T09:30:00Z",
  },
  {
    id: "CLR-2024-005",
    citizen_id: "7",
    ...
    severity: "CRITICAL",
    status: "escalated",
    description: "Used syringes found near public garden",
    gps_lat: 12.9746,
    gps_lng: 77.5936,
    created_at: "2024-03-15T06:20:00Z",
    resolved_at: null,
  },
  {
    id: "CLR-2024-006",
    ...
    severity: "LOW",
    status: "resolved",
    description: "Small pile of unsorted household trash",
    gps_lat: 12.9726,
    gps_lng: 77.5956,
  ...
  },
  {
    ...
    severity: "CRITICAL",
    status: "pending",
    description: "Chemical containers and paint drums near water body",
    gps_lat: 12.9666,
    gps_lng: 77.6006,
  ...
  },
  {
    ...
    severity: "LOW",
    status: "resolved",
    description: "Cardboard boxes and newspapers scattered",
    gps_lat: 12.9736,
    gps_lng: 77.5966,
  ...
  // Additional reports for heatmap richness
  {
    ...
    severity: "HIGH",
    status: "pending",
    description: "Plastic waste overflowing from community bin area",
    gps_lat: 12.958,
    gps_lng: 77.612,
  ...
  },
  {
    ...
    severity: "MEDIUM",
    status: "in-progress",
    description: "Organic waste heap near temple premises",
    gps_lat: 12.964,
    gps_lng: 77.608,
  ...
  },
  {
    ...
    severity: "HIGH",
    status: "overdue",
    description: "Debris from demolished building dumped on road",
    gps_lat: 12.952,
    gps_lng: 77.587,
  ...
  },
  {
    ...
    severity: "LOW",
    status: "resolved",
    description: "Scattered waste near bus stop",
    gps_lat: 12.96,
    gps_lng: 77.6,
  ...
  },
  {
    ...
    severity: "MEDIUM",
    status: "pending",
    description: "Plastic bags and packaging in drainage gutter",
    gps_lat: 12.945,
    gps_lng: 77.615,
  ...
  },
  {
    id: "CLR-2024-014",
    citizen_id: "15",
    citizen_name: "Mohan Rao",
    ward_id: "W-22",
    city_id: "BLR",
    image_url: "",
    category: "domestic_waste",
    severity: "LOW",
    status: "resolved",
    description: "Household trash left outside apartment gate",
    gps_lat: 12.947,
    gps_lng: 77.618,
    created_at: "2024-03-12T06:30:00Z",
    resolved_at: "2024-03-12T14:00:00Z",
  },
  {
    id: "CLR-2024-015",
    citizen_id: "16",
    citizen_name: "Neha Jain",
    ward_id: "W-18",
    city_id: "BLR",
    image_url: "",
    category: "e_waste",
    severity: "MEDIUM",
    status: "in-progress",
    description: "Dumped TV sets and cables behind shopping complex",
    gps_lat: 12.954,
    gps_lng: 77.583,
  ...
  },
  {
    ...
    severity: "HIGH",
    status: "pending",
    description: "Fish market waste piling up near residential area",
    gps_lat: 12.97,
    gps_lng: 77.592,
    created_at: "2024-03-15T05:00:00Z",
    resolved_at: null,
  },
  {
    id: "CLR-2024-017",
    citizen_id: "18",
    citizen_name: "Lakshmi P.",
    ward_id: "W-16",
    city_id: "BLR",
    image_url: "",
    category: "hazardous_waste",
    severity: "CRITICAL",
    status: "escalated",
    description: "Leaking paint drums near children's playground",
    gps_lat: 12.968,
    gps_lng: 77.604,
  ...
  },
  {
    ...
    severity: "LOW",
    status: "resolved",
    description: "Glass bottles and metal cans scattered near park",
    gps_lat: 12.956,
    gps_lng: 77.606,
    created_at: "2024-03-11T14:30:00Z",
    resolved_at: "2024-03-12T09:15:00Z",
  },
  {
    id: "CLR-2024-019",
    citizen_id: "20",
    citizen_name: "Pooja N.",
    ward_id: "W-22",
    city_id: "BLR",
    image_url: "",
    category: "plastic_waste",
    severity: "MEDIUM",
    status: "pending",
    description: "Plastic waste accumulating at vacant lot",
    gps_lat: 12.949,
    gps_lng: 77.62,
  ...
  },
  {
    ...
    severity: "CRITICAL",
    status: "pending",
    description: "Medical waste including syringes near storm drain",
    gps_lat: 12.951,
    gps_lng: 77.586,
...
export const MOCK_CAMPAIGNS = [
  {
    id: "CMP-001",
    title: "Ward 14 Spring Cleanup Drive",
    organizer: "Koramangala Residents Welfare",
    description:
      "Join us for a community cleanup drive to clear persistent waste hotspots in Ward 14. Gloves, bags, and refreshments will be provided.",
    location: "Koramangala, Bangalore",
    event_date: "2024-04-05T09:00:00Z",
    max_participants: 50,
    current_participants: 32,
    status: "active",
    target_waste: "mixed_waste",
    points_reward: 150,
  },
  {
    id: "CMP-002",
    title: "E-Waste Collection Marathon",
    organizer: "GreenTech NGO",
    description:
      "Bring your old electronics for safe, responsible recycling. Free drop-off for all citizens. Earn bonus impact points for every device you recycle.",
    location: "HSR Layout, Bangalore",
    event_date: "2024-04-12T10:00:00Z",
    max_participants: 200,
    current_participants: 87,
    status: "active",
    target_waste: "e_waste",
    points_reward: 200,
  },
  {
    id: "CMP-003",
    title: "Plastic-Free Lake Restoration",
    organizer: "Save Lakes Foundation",
    description:
      "Help clean the Bellandur lake periphery from plastic and mixed waste. Gear will be provided. Photography and social media coverage available.",
    location: "Bellandur Lake, Bangalore",
    event_date: "2024-04-20T07:00:00Z",
    max_participants: 100,
    current_participants: 45,
    status: "active",
    target_waste: "plastic_waste",
    points_reward: 250,
  },
  {
    id: "CMP-004",
    title: "Composting Workshop & Drive",
    organizer: "BBMP Ward 18 Committee",
    description:
      "Learn composting techniques and help set up community composting stations in your neighborhood.",
    location: "Indiranagar, Bangalore",
    event_date: "2024-03-28T10:00:00Z",
    max_participants: 30,
    current_participants: 30,
    status: "closed",
    target_waste: "wet_waste",
    points_reward: 100,
  },
  {
    id: "CMP-005",
    title: "Hazardous Waste Awareness Walk",
    organizer: "KSPCB Bangalore Unit",
    description:
      "A guided awareness walk through industrial zones to understand hazardous waste management practices and responsible disposal protocols.",
    location: "Peenya Industrial Area, Bangalore",
    event_date: "2024-04-25T08:00:00Z",
    max_participants: 75,
    current_participants: 12,
    status: "upcoming",
    target_waste: "hazardous_waste",
    points_reward: 180,
  },
  {
    id: "CMP-006",
    title: "Green Champions Neighborhood Audit",
    organizer: "CivicLens Green Champions - W14",
    description:
      "Monthly neighborhood cleanliness audit by Green Champions. Help us map hotspots and improve ward performance metrics.",
    location: "Koramangala 4th Block, Bangalore",
    event_date: "2024-05-01T06:30:00Z",
    max_participants: 40,
  ...
  {
    id: "CMP-007",
    title: "Construction Debris Clearance Drive",
    organizer: "BBMP PWD Division",
    description:
      "Community + PWD joint drive to clear construction debris from 5 major footpaths in Ward 12. Heavy machinery will be deployed.",
    location: "BTM Layout, Bangalore",
    event_date: "2024-03-20T07:00:00Z",
    max_participants: 60,
    current_participants: 60,
    status: "closed",
    target_waste: "construction_debris",
    points_reward: 200,
  },
];
...
export const MOCK_FACILITIES = [
  {
    id: "FAC-001",
    type: "garbage_center",
    name: "BBMP Waste Collection Center - Koramangala",
    address: "4th Block, Koramangala, Bangalore",
    gps_lat: 12.9352,
    gps_lng: 77.6245,
    accepted_waste: ["plastic_waste", "dry_waste", "wet_waste", "mixed_waste"],
  ...
  },
  {
    ...
    gps_lat: 12.9591,
    gps_lng: 77.6974,
    accepted_waste: ["plastic_waste", "dry_waste", "e_waste"],
    hours: "8:00 AM - 7:00 PM",
    distance: 4.1,
  },
  {
    id: "FAC-005",
    type: "biomedical_handler",
    name: "Bio-Safe Medical Waste Facility",
    address: "Electronic City, Bangalore",
    gps_lat: 12.8458,
    gps_lng: 77.6612,
    accepted_waste: ["biomedical_waste"],
    hours: "24/7",
    distance: 8.3,
  },
  {
    id: "FAC-006",
    type: "scrap_shop",
    name: "Sri Vinayaka Scrap Dealers",
    address: "Jayanagar 4th Block, Bangalore",
    gps_lat: 12.9259,
    gps_lng: 77.5837,
    accepted_waste: ["dry_waste", "plastic_waste"],
...
export const WASTE_CATEGORIES = {
  ...
  dry_waste: {
    ...
    icon: "📦",
    color: "warm",
    department: "Dry Waste Processing",
  },
  wet_waste: {
    label: "Wet Waste",
    icon: "🍂",
    color: "civic",
    department: "Composting / Wet Processing",
  },
  construction_debris: {
    label: "Construction Debris",
    icon: "🧱",
    color: "warm",
    department: "PWD / Debris Removal",
  },
  biomedical_waste: {
    label: "Biomedical Waste",
    icon: "⚠️",
    color: "danger",
    department: "Healthcare Waste Handler",
  },
  hazardous_waste: {
    label: "Hazardous Waste",
    icon: "☢️",
    color: "danger",
    department: "KSPCB / Hazardous Cell",
  },
  e_waste: {
    label: "E-Waste",
    icon: "💻",
    color: "ocean",
    department: "E-Waste Recycler",
  },
  mixed_waste: {
    label: "Mixed Waste",
    icon: "🗑️",
    color: "teal",
    department: "SWM General",
  },
  domestic_waste: {
    label: "Domestic Waste",
    icon: "🏠",
    color: "blush",
    department: "Door-to-door SWM",
  },
};
...
export const MOCK_TEAMS = [
  ...
  },
  {
    id: "TEAM-002",
    name: "Team Bravo",
    members: ["Suresh", "Manoj"],
    size: 2,
    vehicle: "Pickup Van",
    specialization: "wet_waste",
  },
  {
    id: "TEAM-003",
    name: "Team Delta",
    members: ["Arjun", "Vikram", "Ravi", "Imran"],
    size: 4,
    vehicle: "Dump Truck",
    specialization: "construction_debris",
  },
  {
    id: "TEAM-004",
    name: "Team Eco",
